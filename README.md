...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://dev-api.stackbit.com/pull/6089ca40ec31a3001628695c
...
To start editing your site, you can use the Sanity interface at https://mighty-strawberry-9ca40.sanity.studio/.
...
Generated at `2021-04-28T20:49:21.854Z` by Stackbit version `0.3.51`.